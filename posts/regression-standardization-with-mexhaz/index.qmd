...
In this post, I will demonstrate how to use the `mexhaz` package to estimate regression-standardized survival curves. In future posts, I will also cover how to achieve this using the `rstpm2`, `stdReg`, and `marginaleffects` packages for various outcome measures, including in a competing risk setting.
